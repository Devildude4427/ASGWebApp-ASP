                                            ...
                                            <a href="javascript:void(0)" class="link border-top">
                                                <div class="d-flex align-items-center p-10">
                                                    ...
                                                    <div class="m-l-10">
                                                        ...
                                                        <span>Just a reminder that event</span>
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="javascript:void(0)" class="link border-top">
                                            ...
                                            <a href="javascript:void(0)" class="link border-top">
                                                <div class="d-flex align-items-center p-10">
                                                    ...
                                                    <div class="m-l-10">
                                                        ...
                                                        <span>Just see the my admin!</span>
                                                    </div>
                                                </div>
                                            </a>
                                            <a href="javascript:void(0)" class="link border-top">
            ...
            <div class="scroll-sidebar">
                <nav class="sidebar-nav">
                    <ul id="sidebarnav" class="p-t-30">
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" asp-controller="Dashboard" asp-action="Index" aria-expanded="false"><i class="mdi mdi-view-dashboard"></i><span class="hide-menu">Dashboard</span></a></li>
...
<script>
    import ChildComponent from '@/views/ClientDashboard.vue';
